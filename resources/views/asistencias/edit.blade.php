...
@section('titulo','Editar Asistencias')
@section('contenido')
<section class="row pt-3">
	...
	<article class="col-md-4">
		{!! Form::open(['route'=>['asistencias.update',$tipo->id],'method'=>'put']) !!}
			...
			<div class="form-group">
				...
				{!! Form::text('descripcion',$tipo->descripcion,['class'=>'form-control','required']) !!}
			</div>
			<div class="form-group">
